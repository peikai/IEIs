...
tieline_phases_dataframe = pd.read_csv('tables/{element}-free/tieline_non_solubility_and_gas.csv'.format(element=key_element))
...
candidates_calc_dataframe.to_csv('candidates_calc.csv', float_format='%.3f', index=False)