...
# split work into seprated parts to avoid network breaking
...
candidates_dataframe_2nd.to_csv('fullwindow_{element}-free.csv'.format(element=key_element), float_format='%.3f', index=False)
